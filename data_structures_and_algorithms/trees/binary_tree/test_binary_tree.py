...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.binary_tree.insert(Node(1))
        self.binary_tree.insert(Node(2))
        self.binary_tree.insert(Node(3))
        self.binary_tree.insert(Node(4))
        self.binary_tree.insert(Node(5))
        self.binary_tree.insert(Node(6))
        self.binary_tree.insert(Node(7))
