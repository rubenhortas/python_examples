...
def _get_delorean_time_fomrmat(time_):
...
if __name__ == '__main__':
    ...
    print(f"- We could also go to {_get_delorean_date_format(second_dest_date)}... But we need a time, what about {_get_delorean_time_fomrmat(second_dest_time)}?")
